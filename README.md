<div align="center">
  <div>
    <img src="./src/assets/nitwikit-banner.png" alt="nitwikit" />
  </div>
  <b>
    NitWikit
  </b>
...
1. 查阅笨蛋文档的 [贡献指南](./CONTRIBUTING.md)
2. Fork 此仓库至自己的 GitHub 账户下
3. 将自己账户下的仓库克隆至本地
   `git clone https://github.com/你的用户名/NitWikit.git`
4. 在本地仓库中进行修改并构建文档测试，无误后 push 至自己的仓库
5. 回到此仓库，点击 Pull requests -> New pull request 发起 PR
